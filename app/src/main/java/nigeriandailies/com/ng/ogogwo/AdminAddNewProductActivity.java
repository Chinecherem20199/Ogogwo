...
//    Validate the input type here
    ...
    private void StoredProductInformation() {
        ...
        loadingBar.setMessage("Dear Admin Please wait, while we are adding a new product...");
...
//        store the imageView in the fireBase database
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AdminAddNewProductActivity.this, "Your Image Uploaded successfully... ", Toast.LENGTH_SHORT).show();
