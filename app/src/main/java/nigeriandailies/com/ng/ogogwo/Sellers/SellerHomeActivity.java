...
import nigeriandailies.com.ng.ogogwo.admin.AdminCheckNewProductsActivity;
...
//                        To retrieve all the product from a current seller that is online
            ...
            protected void onBindViewHolder(@NonNull ItemViewHolder holder, int position, @NonNull final Products model)
            {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setTitle("Do yo want to Delete this Product. Are you sure?");
    ...
    private void deleteProduct(String productID) {
        ...
        unverifiedProductsRef.child(productID)
            ...
            {
                Toast.makeText(SellerHomeActivity.this, "That item has been deleted successfully.", Toast.LENGTH_SHORT)
                        .show();
            }
        });
    }
